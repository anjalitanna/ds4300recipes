...
@app.route("/")
def index():
    return render_template("index.html", recipe_types=recipe_types, courses=courses, techniques=techniques,
                           cuisines=cuisines)
...
def suggestions():
    ...
    return render_template("index.html", recommendations=stacked, recipe_types=recipe_types,
                           courses=courses, techniques=techniques, cuisines=cuisines)
